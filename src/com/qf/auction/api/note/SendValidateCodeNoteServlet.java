...
public class SendValidateCodeNoteServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		String host = "http://x9xvvi.natappfree.cc/qianfeng_auction/UserSendNote?phoneNumber="
				+ phone + "";
		...
		try {
			...
			httpURLConnection
					.setRequestProperty(
							"User-Agent",
							"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3237.0 Safari/537.36");
			// 设置请求过时时间 为3秒
			...
			// 如果服务器 给的state 是1的话 代表 成功向 聚合平台 发送了短信的请求
